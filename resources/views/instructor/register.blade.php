    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            <div class="block-heading">
                <h2 class="text-info">Instructor Signup</h2>
            </div>
            <form method="POST" action="{{ Route('instructor_register.post') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" placeholder="EX: +20123456789" id="phone" value="{{ old('phone') }}" name="phone">
                    <span class="text-danger">@error('phone') {{$message}} @enderror</span>
                </div>
                <div class="mb-3">
                    <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault1" {{ (old('gender') == 'male' || !old('gender')) ? 'checked' : '' }} value="male">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="EX: bachlors, Phd " id="degree" value="{{ old('degree') }}" name="degree">
                    <span class="text-danger">@error('degree') {{$message}} @enderror</span>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="institute">Institute</label>
                    <input type="text" class="form-control" placeholder="Ex: MIT, GUC" id="institute" value="{{ old('institute') }}" name="institute">
