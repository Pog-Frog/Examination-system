                                ...
                                <div class="col-md-6">
                                    <div class="clean-product-item">
                                        <label class="form-label" for="email">Phone</label>
                                            <input type="phone" class="form-control" id="phone" name="phone" value= "{{ Auth::guard('instructor')->user()->phone }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-md-center" >
                                ...
                                <div class="col-md-6">
                                    <div class="clean-product-item">
                                        <label class="form-label" for="degree">Degree</label>
                                            <input type="degree" class="form-control" id="degree" name="degree" value= "{{ Auth::guard('instructor')->user()->degree }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-md-center" >
                                <div class="col-md-6">
                                    <div class="clean-product-item">
                                        <label class="form-label" for="institute">Institute</label>
                                            <input type="institute" class="form-control" id="institute" name="institute" value= "{{ Auth::guard('instructor')->user()->institute }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-md-center" >
